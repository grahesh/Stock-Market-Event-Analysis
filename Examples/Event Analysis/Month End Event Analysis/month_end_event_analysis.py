...
@author: Grahesh
@summary: Month End Stock Price Event Study
'''
...
def findEvents(symbols, startday,endday, marketSymbol,verbose=False):
        ...
        # Event described is : Analysis given stocks at the end of each month
...
eventProfiler.study(filename="MonthEndEventStudy.jpg",plotErrorBars=True,plotMarketNeutral=True,plotEvents=False,marketSymbol='NSE500')
